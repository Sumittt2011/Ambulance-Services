	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			int requestAmbulance = DatabaseConnection.insertUpdateFromSqlQuery(
					"insert into tblambulance(id,ambulance_vehicle_no,ambulance_type,driver_lincense_no,driver_name,driver_mobile,state,city,status,driver_id)values('"+id+"','"
							+ avn + "','" + ambulanceType + "','" + licenseNo + "','" + driverName + "','"
							+ driverMobile + "','" + state + "','" + city + "','" + status + "','"+ driver_id +"')");
