...
public class ForgotPassword extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String message = "Ambulance Services";
		...
		try {
			...
			if (databaseEmailId.equals(email)) {
				...
				if (resultPassword.next()) {
					...
					userPassword = "Hi " + uname + "," + System.lineSeparator() + System.lineSeparator()+ "Your Patient Login Portal" + System.lineSeparator() + "User Name: " + uname+ System.lineSeparator() + "Password: " + password + System.lineSeparator()+ System.lineSeparator() + "Thank you." + System.lineSeparator()+ "Ambulance Services Team.";
					EmailUtility.sendEmail(host, port, "sumitrajeshinde2011@gmail.com", "d26QpFqCsEgZfm3O", email, message,userPassword);
