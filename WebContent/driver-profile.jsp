			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form role="form" action="EditDriverProfile" method="post">
							<%
							...
							<div class="form-group">
								<label>Patient Id</label> <input class="form-control"
									type="text" name="did"
									value="<%=resultset.getString("driver_id")%>" readonly />
							</div>
							<div class="form-group">
								<label>Full Name</label> <input class="form-control" type="text"
									name="dname" value="<%=resultset.getString("driver_name")%>" />
							</div>
							<div class="form-group">
								<label>Email Id</label> <input class="form-control" name="email"
									type="text" value="<%=resultset.getString("driver_email")%>" />
							</div>
							<div class="form-group">
								<label>Mobile No</label> <input class="form-control"
									name="mobile" type="text"
									value="<%=resultset.getString("driver_mobile")%>" />
							</div>
							<div class="form-group">
								<label>Address</label> <input class="form-control"
									name="address" type="text"
									value="<%=resultset.getString("driver_address")%>" />
							</div>
							<div class="form-group">
