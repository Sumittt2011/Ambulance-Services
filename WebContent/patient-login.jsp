	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-6 col-sm-6 col-xs-12"><br><br>
				<img src="images/paitent2.jpg" width=75%>
			</div>
			<div class="col-md-6 col-sm-6 col-xs-12">
			<div class="panel-heading" style="border-radius: 15px;color: #ff794d; text-shadow: 6px 2px 9px #ff794d; font-size:30px;">Patient Login</div>
				<div class="panel panel-info" style="background-color: #ecf0f3; border-radius: 15px;box-shadow: 13px 13px 20px #cbced1, -13px -13px 20px #fff;">
					...
					%>
					<div class="alert alert-danger" id="info">You have enter wrong verification code.</div>
					<%
						}
					%>
						<form action="PatientLogin" method="post">
							...
							<div class="form-group">
								...
								<input type="text" value="<%=captcha%>" class="form-control" style="width: 180px;" readonly disabled/>
							</div>
							<div class="form-group">
								<label>Enter Verification Code</label>
								<input type="text" name="vercode" class="form-control"
									 placeholder="Enter Verification Code Here" maxlength="5"/>
							</div>
							
							<button type="submit" class="btn btn-info" style="color:white; background:#ff794d">Login
							</button>
							<a class="for-pwd" id="anchNewReg"  href="patient-register.jsp">New Patient Register</a><a class="for-pwd" id="anchForPass" href="patient-forgot-password.jsp">Forgot your password?</a>
						</form>
					</div>
				</div>
			</div>
