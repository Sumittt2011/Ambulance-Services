...
<body class="host_version">
	...
	<div class="container-fluid">
		<div class="row pad-botm">
			<div class="col-md-12">
				<h4 class="header-line">All Patients</h4>
			</div>
		</div>
		<div class="row">
			<div class="col-md-12">
							...
							<table class="table">
								...
								<tbody>
									<tr class="default">
										...
										<%-- <%
											if (resultset.getString("patient_disease") != null) {
										%>
										...
										%>
										<td><span class="label label-danger"><%=resultset.getString("ambulance_status")%></span></td>
										<%
											} else {
										%>
										<td><span class="label label-success"><%=resultset.getString("ambulance_status")%></span></td>
										<%
											}
										}
										%> --%>
