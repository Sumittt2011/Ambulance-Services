	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-6 col-sm-6 col-xs-12"><br><br>
				<img src="images/driver.jpg" width=75%>
			</div>
			<div class="col-md-6 col-sm-6 col-xs-12">
			<div class="panel-heading" style="border-radius: 15px;color: #66ffb3; text-shadow: 6px 2px 9px #66ffb3; font-size:30px;">Driver Login</div>
				<div class="panel panel-default" style="background-color: #ecf0f3; border-radius: 15px;box-shadow: 13px 13px 20px #cbced1, -13px -13px 20px #fff;">
					...
					%>
						<form action="DriverLogin" method="post">
							...
							<button type="submit" class="btn btn-info" style="color:white; background:#66ffb3">Login
							</button>
							<a class="for-pwd" id="anchNewReg" href="driver-register.jsp">New Driver Register</a><a class="for-pwd" id="anchForPass" href="driver-forgot-password.jsp">Forgot your password?</a>
						</form>
					</div>
				</div>
			</div>
