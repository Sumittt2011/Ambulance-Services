	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 col-sm-6 col-xs-12">
				<img src="images/dForgot.jpg" style="width: 75%; height: 70vh">
			</div><br><br><br><br><br>
			<div class="col-md-6 col-sm-6 col-xs-12">
				<%
				...
				<div class="panel panel-default" style="background-color: #ecf0f3; border-radius: 15px;box-shadow: 13px 13px 20px #cbced1, -13px -13px 20px #fff;">
					...
					<div class="panel-body">
						<form action="ForgotDriverPassword" method="post">
							...
							<button type="submit" id="btnValidate" style="background-color: #66ffb3" class="btn btn-info">Get Password</button>
						</form>
					</div>
				</div>
			</div>
