	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-6 col-sm-6 col-xs-12">
				<img src="images/aForgot.jpg" style="width: 75%; height: 70vh">
			</div><br><br><br><br><br>
			<div class="col-md-6 col-sm-6 col-xs-12">
				<%
				...
				%>
				<div class="panel-heading" style="border-radius: 15px;color: cornflowerblue; text-shadow: 6px 2px 9px cornflowerblue; font-size:30px;">Forgot Password</div>
				<div class="panel panel-danger" style="background-color: #ecf0f3; border-radius: 15px;box-shadow: 13px 13px 20px #cbced1, -13px -13px 20px #fff;">
					<div class="panel-body">
						<form action="ForgotAdminPassword" method="post">
							...
							<button type="submit" id="btnValidate" style="background-color:cornflowerblue" class="btn btn-info">Get
								Password</button>
						</form>
					</div>
				</div>
